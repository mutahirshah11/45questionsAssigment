...
// (task 18) 
let PlacesToVisit = ["Hunza", "Chitral", "Swat", "Nathia gali", "Neelum valley"];
console.log(PlacesToVisit); // original order 
let AlphabeticOrder = [...PlacesToVisit];
AlphabeticOrder.sort();
console.log(AlphabeticOrder); // aplhabetic order
console.log(PlacesToVisit);
let ReverseAlphabeticOrder = [...AlphabeticOrder];
...
// (task 20) 
let Countries = ["Pakistan", "india", 'China', 'Iran', 'USA', 'UK', 'Afghanistan'];
let car = {
    name: 'Toyota Corolla',
    price: 4500000,
    Tangible: true
...
// (task 29 )
let favorite_fruits = ['apple', 'banana', 'orange', 'pineapple', 'kiwi'];
...
// (task 34 )
let Pizza = ["Cheese Pizza", "Pepperoni Pizza", "Malai Boti Pizaa"];
